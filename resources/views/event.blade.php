            ...
            <form method="post" action="{{route('event.insert')}}">
                ...
                @method('post')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="implementation" id="implementation" placeholder="Enter implementation">
                    </div>
                    <!-- End input fields -->
                </div>
        ...
        <div class="modal-content">
            ...
            <form id="editDataForm" method="post" action="">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="year" id="editYear" placeholder="Enter new year">
                </div>
                <div class="mb-3">
                    <label for="editImplementation" class="form-label">Implementation</label>
                    <input type="text" class="form-control" name="implementation" id="editImplementation" placeholder="Enter new implementation">
                </div>
                <div class="modal-footer">
